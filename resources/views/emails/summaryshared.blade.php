                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                        <table cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                            <tr>
                                <td>
                                    <p style="margin: 0;">Dear {{ $receiver->fullname }},</p>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 20px 0 30px 0;">
                                    <p style="margin: 0;">A new summary has been shared with you. Below are the details - </p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p style="margin: 0;"><strong>From</strong> - {{ $sender->fullname }}</p>
